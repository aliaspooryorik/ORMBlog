...
* I am a Post Entity
*/
component persistent="true" table="tbl_Post" 
{
	/* ----------------------------------------- PROPERTIES -----------------------------------------  */
	/*
	...
	*/ 	
	property name="Comments" cfc="model.post.Comment" fieldtype="one-to-many" type="array"
		fkcolumn="IDPost"; 
	...
	*/ 	
	property name="Categories" cfc="model.system.Category" fieldtype="many-to-many" type="array"
